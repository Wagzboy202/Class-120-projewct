...
def preprocess_user_input(user_input):
    ...
    tokenized_user_input = nltk.tokenize(user_input)
    # convert the user input into its root words : stemming
    input1 = get_stem_words(tokenized_user_input, ignore_words)
    # Remove duplicacy and sort the user_input
    
    input3 = sorted(list(set(input1)))
